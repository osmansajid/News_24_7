...
class SportsNewsListViewModel @ViewModelInject constructor(repository: NewsRepository, @ApplicationContext appContext: Context, @androidx.hilt.Assisted savedState: SavedStateHandle
): ViewModel() {
    companion object{
